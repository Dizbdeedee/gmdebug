...
@:jsRequire("ffi-napi", "VariadicForeignFunction") extern class VariadicForeignFunction {
	function new(ptr:global.Buffer, ret:ts.AnyOf2<String, ref_napi.Type_>,
		fixedArgs:Array<ts.AnyOf2<String, ref_napi.Type_>>, ?abi:Float);
	...
	**/
	...
	@:selfCall
	static function call_(ptr:global.Buffer, ret:ts.AnyOf2<String, ref_napi.Type_>,
		fixedArgs:Array<ts.AnyOf2<String, ref_napi.Type_>>, ?abi:Float):VariadicForeignFunction;
}
