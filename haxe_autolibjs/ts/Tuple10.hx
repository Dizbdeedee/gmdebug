...
**/
@:forward @:forwardStatics extern abstract Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(std.Array<Any>)
	from std.Array<Any> to std.Array<Any> {
	public inline function new(element0:T0, element1:T1, element2:T2, element3:T3, element4:T4, element5:T5,
			element6:T6, element7:T7, element8:T8, element9:T9) {
		this = [
	...
	inline function get_element6():T6
		return cast this[6];

	inline function set_element6(v:T6):T6
		return cast this[6] = cast v;

	public var element7(get, set):T7;

	inline function get_element7():T7
		return cast this[7];

	inline function set_element7(v:T7):T7
		return cast this[7] = cast v;

	public var element8(get, set):T8;

	inline function get_element8():T8
		return cast this[8];

	inline function set_element8(v:T8):T8
		return cast this[8] = cast v;

	public var element9(get, set):T9;

	inline function get_element9():T9
		return cast this[9];

	inline function set_element9(v:T9):T9
		return cast this[9] = cast v;
}
