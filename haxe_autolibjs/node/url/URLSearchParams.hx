...
@:jsRequire("url", "URLSearchParams") extern class URLSearchParams {
	function new(?init:ts.AnyOf5<String, haxe.ds.ReadOnlyArray<ts.Tuple2<String, String>>, URLSearchParams,
		Iterable<ts.Tuple2<String, String>>,
		global.nodejs.Dict<ts.AnyOf2<String, haxe.ds.ReadOnlyArray<String>>>>);
	...
	**/
	...
	/**
		...
		```
	**/
	function forEach<TThis>(callback:(value:String, name:String, searchParams:URLSearchParams) -> Void,
		?thisArg:TThis):Void;
