...
@:jsRequire("http", "OutgoingMessage") extern class OutgoingMessage extends node.stream.Writable {
	...
	**/
	function setHeader(name:String,
		value:ts.AnyOf3<String, Float, haxe.ds.ReadOnlyArray<String>>):OutgoingMessage;
	...
	**/
	function addTrailers(headers:ts.AnyOf2<OutgoingHttpHeaders, haxe.ds.ReadOnlyArray<ts.Tuple2<String,
		String>>>):Void;
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):OutgoingMessage {})
