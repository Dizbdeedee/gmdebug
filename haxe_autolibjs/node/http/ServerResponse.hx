...
@:jsRequire("http", "ServerResponse") extern class ServerResponse extends OutgoingMessage {
	...
	**/
	@:overload(function(statusCode:Float,
		?headers:ts.AnyOf2<OutgoingHttpHeaders, Array<OutgoingHttpHeader>>):ServerResponse {})
	function writeHead(statusCode:Float, ?statusMessage:String,
		?headers:ts.AnyOf2<OutgoingHttpHeaders, Array<OutgoingHttpHeader>>):ServerResponse;
	...
	**/
	function setHeader(name:String,
		value:ts.AnyOf3<String, Float, haxe.ds.ReadOnlyArray<String>>):ServerResponse;
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ServerResponse {})
