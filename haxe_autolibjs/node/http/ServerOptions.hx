	...
	var IncomingMessage:{
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:ServerOptions, eventName:String,
			?options:ServerOptions):js.lib.Promise<Array<Dynamic>> {})
		function once(emitter:ServerOptions, eventName:ts.AnyOf2<String, js.lib.Symbol>,
			?options:ServerOptions):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
		...
		**/
		function on(emitter:global.nodejs.EventEmitter, eventName:String,
			?options:ServerOptions):js.lib.AsyncIterableIterator<Dynamic>;
		/**
		...
		**/
		...
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<global.nodejs.EventEmitter, ServerOptions>,
