...
@:jsRequire("http", "Server") extern class Server extends node.net.Server {
	...
	**/
	...
	@:overload(function(event:String,
		listener:(req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server {})
	@:overload(function(event:String, listener:RequestListener):Server {})
	@:overload(function(event:String,
		listener:(req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server {})
	...
	**/
	...
	@:overload(function(event:String, req:IncomingMessage, socket:node.stream.Duplex,
