...
@:jsRequire("http", "ClientRequest") extern class ClientRequest extends OutgoingMessage {
	...
	**/
	@:overload(function(event:String,
		listener:(response:IncomingMessage, socket:node.net.Socket,
			head:node.buffer.Buffer) -> Void):ClientRequest {})
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ClientRequest {})
	...
	**/
	function setHeader(name:String,
		value:ts.AnyOf3<String, Float, haxe.ds.ReadOnlyArray<String>>):ClientRequest;
