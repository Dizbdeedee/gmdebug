...
typedef RequestOptions = {
	...
	var setHost:Bool;
	@:optional
	dynamic function createConnection(options:ClientRequestArgs,
		oncreate:(err:js.lib.Error, socket:node.net.Socket) -> Void):node.net.Socket;
};
