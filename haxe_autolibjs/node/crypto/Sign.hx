...
@:jsRequire("crypto", "Sign") extern class Sign extends node.stream.Writable {
	...
	**/
	@:overload(function(privateKey:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, SignKeyObjectInput,
		SignPrivateKeyInput>,
		outputFormat:BinaryToTextEncoding):String {})
	function sign(privateKey:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, SignKeyObjectInput,
		SignPrivateKeyInput>):node.buffer.Buffer;
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Sign {})
