...
@:jsRequire("async_hooks", "AsyncResource") extern class AsyncResource {
	...
	**/
	function runInAsyncScope<This, Result>(fn:(args:haxe.extern.Rest<Dynamic>) -> Result, ?thisArg:This,
		args:haxe.extern.Rest<Dynamic>):Result;
	...
	**/
	@:native("bind")
	static function bind_<Func, ThisArg>(fn:Func, ?type:String, ?thisArg:ThisArg):Dynamic;
}
