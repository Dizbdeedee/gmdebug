...
@:jsRequire("node:url") @valueModuleOnly extern class NodeUrl {
	...
	**/
	@:overload(function(urlString:String, parseQueryString:Null<Bool>,
		?slashesDenoteHost:Bool):node.url.UrlWithStringQuery {})
	@:overload(function(urlString:String, parseQueryString:Bool,
		?slashesDenoteHost:Bool):node.url.UrlWithParsedQuery {})
