...
typedef ChildProcessWithoutNullStreams = {
	...
	**/
	...
	/**
		...
		not be successfully spawned.
	**/
	final stdio:ts.Tuple5<node.stream.Writable, node.stream.Readable, node.stream.Readable,
		Null<ts.AnyOf2<node.stream.Readable, node.stream.Writable>>,
		Null<ts.AnyOf2<node.stream.Readable, node.stream.Writable>>>;
	...
	**/
	@:overload(function(message:Serializable, ?sendHandle:SendHandle,
		?callback:(error:Null<js.lib.Error>) -> Void):Bool {})
	@:overload(function(message:Serializable, ?sendHandle:SendHandle, ?options:MessageOptions,
		?callback:(error:Null<js.lib.Error>) -> Void):Bool {})
	...
	**/
	@:overload(function(event:String,
		listener:(code:Null<Float>,
			signal:Null<global.nodejs.Signals>) -> Void):ChildProcessWithoutNullStreams {})
	...
	@:overload(function(event:String,
		listener:(code:Null<Float>,
			signal:Null<global.nodejs.Signals>) -> Void):ChildProcessWithoutNullStreams {})
	@:overload(function(event:String,
		listener:(message:Serializable, sendHandle:SendHandle) -> Void):ChildProcessWithoutNullStreams {})
	@:overload(function(event:String, listener:() -> Void):ChildProcessWithoutNullStreams {})
	function addListener(event:String,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcessWithoutNullStreams;
