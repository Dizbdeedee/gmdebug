...
typedef ChildProcessByStdio<I, O, E> = {
	...
	**/
	...
	/**
		...
		not be successfully spawned.
	**/
	final stdio:ts.Tuple5<I, O, E, Null<ts.AnyOf2<node.stream.Readable, node.stream.Writable>>,
	...
	**/
	@:overload(function(event:String,
		listener:(code:Null<Float>,
			signal:Null<global.nodejs.Signals>) -> Void):ChildProcessByStdio<I, O, E> {})
	...
	@:overload(function(event:String,
		listener:(code:Null<Float>,
			signal:Null<global.nodejs.Signals>) -> Void):ChildProcessByStdio<I, O, E> {})
	@:overload(function(event:String,
		listener:(message:Serializable, sendHandle:SendHandle) -> Void):ChildProcessByStdio<I, O, E> {})
	@:overload(function(event:String, listener:() -> Void):ChildProcessByStdio<I, O, E> {})
	function addListener(event:String,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcessByStdio<I, O, E>;
