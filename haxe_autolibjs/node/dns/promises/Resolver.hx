...
@:jsRequire("dns", "promises.Resolver") extern class Resolver {
	...
	@:overload(function(hostname:String,
		rrtype:String):js.lib.Promise<ts.AnyOf7<Array<String>, node.dns.SoaRecord, Array<node.dns.AnyRecord>
	...
	@:overload(function(hostname:String,
		options:node.dns.ResolveWithTtlOptions):js.lib.Promise<Array<node.dns.RecordWithTtl>> {})
	@:overload(function(hostname:String,
		options:node.dns.ResolveOptions):js.lib.Promise<ts.AnyOf2<Array<String>,
			Array<node.dns.RecordWithTtl>>> {})
