...
@:jsRequire("repl", "REPLServer") extern class REPLServer extends node.readline.Interface {
	...
	**/
	function eval(evalCmd:String, context:node.vm.Context, file:String,
		cb:(err:Null<js.lib.Error>, result:Dynamic) -> Void):Void;
	...
	**/
	function completer(line:String,
		callback:ts.AnyOf3<() -> Void, (err:js.lib.Error) -> Void,
			(err:js.lib.Error,
					result:node.readline.CompleterResult) -> Void>):ts.AnyOf2<ts.Undefined,
			node.readline.CompleterResult>;
	...
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):REPLServer;
