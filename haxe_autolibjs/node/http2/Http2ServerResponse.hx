...
@:jsRequire("http2", "Http2ServerResponse") extern class Http2ServerResponse extends node.stream.Writable {
	...
	**/
	...
	@:overload(function(data:ts.AnyOf2<String, js.lib.Uint8Array>, encoding:global.BufferEncoding,
		?callback:() -> Void):Void {})
	...
	**/
	@:overload(function(chunk:ts.AnyOf2<String, js.lib.Uint8Array>, encoding:global.BufferEncoding,
		?callback:(err:js.lib.Error) -> Void):Bool {})
	...
	**/
	...
	/**
		...
		will result in a `TypeError` being thrown.
	**/
	@:overload(function(statusCode:Float, statusMessage:String,
		?headers:node.http.OutgoingHttpHeaders):Http2ServerResponse {})
	...
	**/
	function createPushResponse(headers:node.http.OutgoingHttpHeaders,
		callback:(err:Null<js.lib.Error>, res:Http2ServerResponse) -> Void):Void;
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2ServerResponse {})
