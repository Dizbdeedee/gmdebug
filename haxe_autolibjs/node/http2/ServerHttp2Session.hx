...
typedef ServerHttp2Session = {
	...
	/**
		...
		ASCII origin.
	**/
	function altsvc(alt:String,
		originOrStream:ts.AnyOf4<String, Float, node.url.URL, AlternativeServiceOptions>):Void;
	...
	**/
	@:overload(function(event:String,
		listener:(stream:ServerHttp2Stream, headers:IncomingHttpHeaders,
			flags:Float) -> Void):ServerHttp2Session {})
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ServerHttp2Session {})
	function addListener(event:String,
		listener:(session:ServerHttp2Session,
			socket:ts.AnyOf2<node.net.Socket, node.tls.TLSSocket>) -> Void):ServerHttp2Session;
	...
	/**
		...
		```
	**/
	@:overload(function(event:String, stream:ServerHttp2Stream, headers:IncomingHttpHeaders,
		flags:Float):Bool {})
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, args:haxe.extern.Rest<Dynamic>):Bool {})
	function emit(event:String, session:ServerHttp2Session,
