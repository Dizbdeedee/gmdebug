...
typedef Http2Session = {
	...
	**/
	...
	@:overload(function(event:String,
		listener:(frameType:Float, errorCode:Float, streamID:Float) -> Void):Http2Session {})
	@:overload(function(event:String,
		listener:(errorCode:Float, lastStreamID:Float,
			opaqueData:node.buffer.Buffer) -> Void):Http2Session {})
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Session {})
	...
	**/
	...
	@:overload(function(event:String, errorCode:Float, lastStreamID:Float,
		opaqueData:node.buffer.Buffer):Bool {})
