	...
	var Http1IncomingMessage:{
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:SecureServerOptions, eventName:String,
			?options:SecureServerOptions):js.lib.Promise<Array<Dynamic>> {})
		function once(emitter:SecureServerOptions, eventName:ts.AnyOf2<String, js.lib.Symbol>,
			?options:SecureServerOptions):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
		...
		**/
		function on(emitter:global.nodejs.EventEmitter, eventName:String,
			?options:SecureServerOptions):js.lib.AsyncIterableIterator<Dynamic>;
		/**
		...
		**/
		...
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<global.nodejs.EventEmitter, SecureServerOptions>,
