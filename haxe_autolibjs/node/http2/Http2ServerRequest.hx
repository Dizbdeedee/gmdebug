...
@:jsRequire("http2", "Http2ServerRequest") extern class Http2ServerRequest extends node.stream.Readable {
	function new(stream:ServerHttp2Stream, headers:IncomingHttpHeaders, options:node.stream.ReadableOptions,
		rawHeaders:haxe.ds.ReadOnlyArray<String>);
	...
	**/
	...
	@:overload(function(event:String,
		listener:(chunk:ts.AnyOf2<String, node.buffer.Buffer>) -> Void):Http2ServerRequest {})
	@:overload(function(event:String, listener:() -> Void):Http2ServerRequest {})
	@:overload(function(event:String, listener:() -> Void):Http2ServerRequest {})
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2ServerRequest {})
	...
	**/
	...
	function prependOnceListener(event:String,
		listener:(hadError:Bool, code:Float) -> Void):Http2ServerRequest;
