	...
	var Http1IncomingMessage:{
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:ServerSessionOptions, eventName:String,
			?options:ServerSessionOptions):js.lib.Promise<Array<Dynamic>> {})
		function once(emitter:ServerSessionOptions, eventName:ts.AnyOf2<String, js.lib.Symbol>,
			?options:ServerSessionOptions):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
		...
		**/
		function on(emitter:global.nodejs.EventEmitter, eventName:String,
			?options:ServerSessionOptions):js.lib.AsyncIterableIterator<Dynamic>;
		/**
		...
		**/
		...
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<global.nodejs.EventEmitter, ServerSessionOptions>,
