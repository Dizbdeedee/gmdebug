...
@:jsRequire("cluster", "Worker") extern class Worker extends node.Events {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(message:node.child_process.Serializable, sendHandle:node.child_process.SendHandle,
		?callback:(error:Null<js.lib.Error>) -> Void):Bool {})
	@:overload(function(message:node.child_process.Serializable, sendHandle:node.child_process.SendHandle,
		?options:node.child_process.MessageOptions, ?callback:(error:Null<js.lib.Error>) -> Void):Bool {})
	...
	**/
	...
	@:overload(function(event:String,
		listener:(message:Dynamic, handle:node.child_process.SendHandle) -> Void):Worker {})
	@:overload(function(event:String, listener:() -> Void):Worker {})
	...
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Worker;
