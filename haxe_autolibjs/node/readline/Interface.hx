...
@:jsRequire("readline", "Interface") extern class Interface extends node.Events {
	...
	**/
	...
	private function new(input:global.nodejs.ReadableStream, ?output:global.nodejs.WritableStream,
		?completer:ts.AnyOf2<Completer, AsyncCompleter>, ?terminal:Bool);
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(query:String, options:node.events.eventemitter.Abortable,
		callback:(answer:String) -> Void):Void {})
	...
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Interface;
