...
@:jsRequire("node:timers") @valueModuleOnly extern class NodeTimers {
	...
	dynamic static function setTimeout(handler:js.html.TimerHandler, ?timeout:Float,
	...
	dynamic static function setInterval(handler:js.html.TimerHandler, ?timeout:Float,
		arguments:haxe.extern.Rest<Dynamic>):Float;
	...
	dynamic static function setImmediate<TArgs>(callback:(args:haxe.extern.Rest<Any>) -> Void,
