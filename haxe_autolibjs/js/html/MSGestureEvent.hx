...
@:native("MSGestureEvent") extern class MSGestureEvent {
	...
	function initGestureEvent(typeArg:String, canBubbleArg:Bool, cancelableArg:Bool, viewArg:js.html.Window,
		detailArg:Float, screenXArg:Float, screenYArg:Float, clientXArg:Float, clientYArg:Float,
		offsetXArg:Float, offsetYArg:Float, translationXArg:Float, translationYArg:Float, scaleArg:Float,
		expansionArg:Float, rotationArg:Float, velocityXArg:Float, velocityYArg:Float,
	...
	**/
	...
	final NONE:Float;
	static var prototype:MSGestureEvent;
