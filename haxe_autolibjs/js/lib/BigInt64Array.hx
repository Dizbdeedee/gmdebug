...
@:native("BigInt64Array") extern class BigInt64Array {
	...
	**/
	function every(callbackfn:(value:BigInt, index:Float, array:BigInt64Array) -> Bool,
	...
	**/
	function filter(callbackfn:(value:BigInt, index:Float, array:BigInt64Array) -> Dynamic,
		?thisArg:Dynamic):BigInt64Array;

	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:BigInt, index:Float, array:BigInt64Array) -> Bool,
	...
	/**
		...
		otherwise.
	**/
	function findIndex(predicate:(value:BigInt, index:Float, array:BigInt64Array) -> Bool,
		?thisArg:Dynamic):Float;

	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:BigInt, index:Float, array:BigInt64Array) -> Void,
	...
	**/
	function map(callbackfn:(value:BigInt, index:Float, array:BigInt64Array) -> BigInt,
		?thisArg:Dynamic):BigInt64Array;
