...
typedef BufferConstructor = {
	...
	**/
	...
	function from(arrayBuffer:WithImplicitCoercion<ts.AnyOf2<js.lib.ArrayBuffer, js.lib.SharedArrayBuffer>>,
	...
	**/
	function byteLength(string:ts.AnyOf15<String, js.lib.Int8Array, js.lib.ArrayBuffer,
