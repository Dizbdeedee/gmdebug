...
@:native("") extern class NodeGlobal {
	...
	**/
	...
	static function setImmediate<TArgs>(callback:(args:haxe.extern.Rest<Any>) -> Void,
		args:haxe.extern.Rest<Any>):global.nodejs.Immediate;
	...
	static var global:{
		...
		**/
		...
		function departFocus(navigationReason:js.html.NavigationReason,
			origin:js.html.FocusNavigationOrigin):Void;
		function focus():Void;
		...
		function postMessage(message:Dynamic, targetOrigin:String,
			?transfer:Array<js.html.Transferable>):Void;
		function print():Void;
		...
		function webkitConvertPointFromNodeToPage(node:js.html.Node,
			pt:js.html.WebKitPoint):js.html.WebKitPoint;
		function webkitConvertPointFromPageToNode(node:js.html.Node,
			pt:js.html.WebKitPoint):js.html.WebKitPoint;
		...
		**/
		...
		@:overload(function(image:js.html.ImageBitmapSource, sx:Float, sy:Float, sw:Float,
			sh:Float):js.lib.Promise<js.html.ImageBitmap> {})
		...
		@:overload(function<TArgs>(callback:(args:haxe.extern.Rest<Any>) -> Void, ?ms:Float,
			args:haxe.extern.Rest<Any>):global.nodejs.Timer {})
		@:overload(function(callback:(args:ts.Undefined) -> Void, ?ms:Float):global.nodejs.Timer {})
		function setInterval(handler:js.html.TimerHandler, ?timeout:Float,
			arguments:haxe.extern.Rest<Dynamic>):Float;
		@:overload(function<TArgs>(callback:(args:haxe.extern.Rest<Any>) -> Void, ?ms:Float,
			args:haxe.extern.Rest<Any>):global.nodejs.Timeout {})
		@:overload(function(callback:(args:ts.Undefined) -> Void, ?ms:Float):global.nodejs.Timeout {})
		function setTimeout(handler:js.html.TimerHandler, ?timeout:Float,
			arguments:haxe.extern.Rest<Dynamic>):Float;
		@:overload(function(type:String, listener:js.html.EventListenerOrEventListenerObject,
			?options:ts.AnyOf2<Bool, js.html.AddEventListenerOptions>):Void {})
		function addEventListener<K>(type:K, listener:(ev:Dynamic) -> Dynamic,
			?options:ts.AnyOf2<Bool, js.html.AddEventListenerOptions>):Void;
		@:overload(function(type:String, listener:js.html.EventListenerOrEventListenerObject,
			?options:ts.AnyOf2<Bool, js.html.EventListenerOptions>):Void {})
		function removeEventListener<K>(type:K, listener:(ev:Dynamic) -> Dynamic,
			?options:ts.AnyOf2<Bool, js.html.EventListenerOptions>):Void;
		var RTCStatsReport:{
		...
		**/
		var IDBKeyRange:{
			...
			**/
			function bound(lower:Dynamic, upper:Dynamic, ?lowerOpen:Bool,
				?upperOpen:Bool):js.html.idb.KeyRange;
			/**
		...
		**/
		@:optional
		dynamic function onerror(event:ts.AnyOf2<String, js.html.Event>, ?source:String, ?lineno:Float,
			?colno:Float, ?error:js.lib.Error):Dynamic;
		/**
		...
		**/
		...
		@:overload(function(callback:(args:ts.Undefined) -> Void):global.nodejs.Immediate {})
		function setImmediate<TArgs>(callback:(args:haxe.extern.Rest<Any>) -> Void,
			args:haxe.extern.Rest<Any>):global.nodejs.Immediate;
