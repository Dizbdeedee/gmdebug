...
typedef Process = {
	...
	**/
	@:overload(function(warning:ts.AnyOf2<String, js.lib.Error>, ?type:String,
		?ctor:haxe.Constraints.Function):Void {})
	@:overload(function(warning:ts.AnyOf2<String, js.lib.Error>, ?type:String, ?code:String,
		?ctor:haxe.Constraints.Function):Void {})
	...
	**/
	@:optional
	function send(message:Dynamic, ?sendHandle:Dynamic, ?options:{@:optional var swallowErrors:Bool;},
	...
	**/
	...
	@:overload(function(event:String, type:MultipleResolveType, promise:js.lib.Promise<Any>,
		value:Any):Process {})
	@:overload(function(event:String, listener:WorkerListener):Process {})
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Process {})
