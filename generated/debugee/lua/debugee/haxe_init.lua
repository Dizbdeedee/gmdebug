...
__gmod_helpers__PairTools_KeyTable_Impl_ = _hx_e()
...
__tink_json_Writer205 = _hx_e()
__tink_json_Writer206 = _hx_e()
__tink_json_Writer207 = _hx_e()
__tink_json_Writer208 = _hx_e()
...
LuaLambdaKeys.fold = function(it,f,first) 
  local x = __gmod_helpers__PairTools_KeyTable_Impl_.iterator(it);
  while (x:hasNext()) do 
...
__gmdebug_lua_DebugLoop.debugloop = function(cur,currentLine) 
  ...
  if (not stepping and bpValid) then 
    if (((sinfo ~= nil) and (__gmdebug_lua_DebugLoop.highestStackHeight ~= nil)) and (__gmdebug_lua_DebugLoop.escapeHatch ~= nil)) then 
      if (not __gmdebug_lua_DebugLoop.lineSteppin and __gmdebug_lua_DebugLoop.bm:breakpointWithinRange(sinfo.source, sinfo.linedefined, sinfo.lastlinedefined)) then 
        local sh;
...
__gmdebug_lua_Debugee.start = function() 
  ...
  __haxe_Log.trace("Connected to server...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=119,className="gmdebug.lua.Debugee",methodName="start"}));
  ...
  if (not __gmdebug_lua_Debugee.startLoop()) then 
    __haxe_Log.trace("Failed to setup debugger after timeout", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=133,className="gmdebug.lua.Debugee",methodName="start"}));
    do return false end;
  end;
  _G.DebugHook.addHook("gmdebug", __gmdebug_lua_DebugLoop.debugloop, "c");
...
__gmdebug_lua_Debugee.traceback = function(err) 
  ...
  if (__gmdebug_lua_Debugee.inpauseloop or __gmdebug_lua_Debugee.tracing) then 
    __haxe_Log.trace(Std.string(Std.string(Std.string("traceback failed... ") .. Std.string(Std.string(__gmdebug_lua_Debugee.inpauseloop))) .. Std.string(" ")) .. Std.string(Std.string(__gmdebug_lua_Debugee.tracing)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=190,className="gmdebug.lua.Debugee",methodName="traceback"}));
    do return err end;
  end;
  local tmp;
  ...
  if (not __gmdebug_lua_Debugee.hooksActive or not __gmdebug_lua_Debugee.active) then 
    do return err end;
  end;
...
__gmdebug_lua_Debugee.poll = function() 
  ...
  elseif not _hx_status then 
    ...
    __haxe_Log.trace(_g:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=259,className="gmdebug.lua.Debugee",methodName="poll"}));
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result
  end;
end
__gmdebug_lua_Debugee.main = function() 
  ...
  _G.timer.Create("gmdebug-start", 3, 0, function() 
    ...
    elseif not _hx_status then 
      ...
      __haxe_Log.trace(Std.string("closed socket on error ") .. Std.string(_g:toString()), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=293,className="gmdebug.lua.Debugee",methodName="main"}));
...
__gmdebug_lua_Debugee.startHaltLoop = function(reason,bd,txt) 
  ...
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  __haxe_Log.trace("HALT LOOP", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=331,className="gmdebug.lua.Debugee",methodName="startHaltLoop"}));
...
__gmdebug_lua_Debugee.abortDebugee = function() 
  ...
  __haxe_Log.trace("Debugging aborted", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=354,className="gmdebug.lua.Debugee",methodName="abortDebugee"}));
...
__gmdebug_lua_Exceptions.addExcept = function(x) 
  ...
  local func = function (...) local success,vargs = xpcall(_G.__oldFuncs[i - 1],_G.__gmdebugTraceback,...) if success then return vargs else print("baddy bad!", __gmdebug_lua_Exceptions.debugNames.h[__gmdebug_lua_Exceptions.oldFuncs[i - 1]]) error(vargs,99) end end;
...
__gmdebug_lua_Exceptions.hookGamemodeHooks = function() 
  ...
  while (_g_hasNext()) do 
    ...
    local hook = _g.value;
    local table = _hx_tab_array({[0]=hook}, 1);
    local _hx_3_p_next, _hx_3_p_table, _hx_3_p_index = _G.pairs(table[0]);
    local next = _hx_tab_array({[0]=_hx_3_p_next}, 1);
    ...
    while (_g2_hasNext()) do 
      ...
      if ((_G.type(x) == "function") and (__gmdebug_lua_Exceptions.exceptFuncs.k[x] == nil)) then 
        local _this = __gmdebug_lua_Exceptions.debugNames;
        _this.h[hooks] = ident;
        _this.k[hooks] = true;
  ...
  _G.gamemode.Register = function(gm,name,derived) 
    local table = gm;
    local _hx_7_p_next, _hx_7_p_table, _hx_7_p_index = _G.pairs(table);
    local next = _hx_7_p_next;
    local i = _hx_7_p_index;
    local _g_next = function() 
      local _hx_8_res_index, _hx_8_res_value = next(table, i);
      i = _hx_8_res_index;
      do return _hx_o({__fields__={key=true,value=true},key=_hx_8_res_index,value=_hx_8_res_value}) end;
    end;
    local _g_hasNext = function() 
      do return _G.select(2, _G.next(table, i)) ~= nil end;
    end;
...
__gmdebug_lua_Exceptions.hookInclude = function() 
  ...
  _G.include = function(str) 
    ...
    if (relative == true) then 
      compileFunc = _G.CompileString(_G.file.Read(findPth, "GAME"), findPth, false);
    else
      if (nonrelative == true) then 
        compileFunc = _G.CompileString(_G.file.Read(str, "LUA"), str, false);
      else
        __haxe_Log.trace(Std.string("Could not catch exceptions for included file : ") .. Std.string(str), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Exceptions.hx",lineNumber=110,className="gmdebug.lua.Exceptions",methodName="hookInclude"}));
        do return _G.__oldInclude(str) end;
      end;
    end;
    if (not __lua_Boot.__instanceof(compileFunc, String)) then 
      local fun = __gmdebug_lua_Exceptions.addExcept(compileFunc);
      fun();
    end;
    do return _G.__oldInclude(str) end;
  end;
...
__gmdebug_lua_Exceptions.createWrapperTable = function(target) 
  local wrapper = ({});
  local meta = ({});
  meta.__index = target;
  meta.__newindex = function(_,ind,val) 
    local newVal;
    local newVal1;
    if (_G.TypeID(val) == _G.TYPE_FUNCTION) then 
      local x = val;
      newVal1 = (_G.type(x) == "function") and (__gmdebug_lua_Exceptions.exceptFuncs.k[x] == nil);
    else
      newVal1 = false;
    end;
    if (newVal1) then 
      _G.print("update ", ind);
      newVal = __gmdebug_lua_Exceptions.addExcept(val);
    else
      local x = val;
      _G.print(Std.string(Std.string(Std.string(Std.string(Std.string("not updating... ") .. Std.string(Std.string(ind))) .. Std.string(" reason ")) .. Std.string(Std.string(_G.TypeID(val) == _G.TYPE_FUNCTION))) .. Std.string(" ")) .. Std.string(Std.string((_G.type(x) == "function") and (__gmdebug_lua_Exceptions.exceptFuncs.k[x] == nil))));
      newVal = val;
    end;
    target[ind] = newVal do return target[ind] end;
  end;
  _G.setmetatable(wrapper, meta);
  do return wrapper end;
end
__gmdebug_lua_Exceptions.hookEntityHooks = function() 
  local entName = __gmod_helpers__PairTools_KeyTable_Impl_.iterator(_G.scripted_ents.GetList());
  while (entName:hasNext()) do 
    ...
    entTbl.t = __gmdebug_lua_Exceptions.createWrapperTable(entTbl.t);
  end;
end
...
__gmdebug_lua_handlers_HScopes.prototype.handle = function(self,scopeReq) 
  ...
  local js = __tink_json_Writer205.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmdebug_lua_handlers_HSetBreakpoints.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer206.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmdebug_lua_handlers_HStackTrace.prototype.handle = function(self,x) 
  ...
  if (not __gmdebug_lua_Debugee.inpauseloop) then 
    ...
    local js = __tink_json_Writer208.new():write(response);
    local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
    __gmdebug_lua_Debugee.socket.output:writeString(str);
    __gmdebug_lua_Debugee.socket.output:flush();
...
__gmdebug_lua_handlers_HVariables.prototype.child = function(self,ref) 
  ...
  if (storedvar == nil) then 
    __haxe_Log.trace(Std.string("Variable requested with nothing stored! ") .. Std.string(ref), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/handlers/HVariables.hx",lineNumber=85,className="gmdebug.lua.handlers.HVariables",methodName="child"}));
  end;
...
__gmdebug_lua_handlers_HVariables.prototype.frameLocal = function(self,frame,scope) 
  ...
  elseif (scope) == 3 then 
    local info = _G.debug.getinfo(frame + 2, "f");
    if ((info ~= nil) and (info.func ~= nil)) then 
      local table = _G.debug.getfenv(info.func);
...
__gmdebug_lua_handlers_HVariables.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer207.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmod_helpers__LuaArray_LuaArray_Impl_.__name__ = true
__gmod_helpers__LuaArray_LuaArray_Impl_.keyValueIterator = function(this1) 
...
__gmod_helpers__PairTools_KeyTable_Impl_.new = {}
__gmod_helpers__PairTools_KeyTable_Impl_.__name__ = true
__gmod_helpers__PairTools_KeyTable_Impl_.iterator = function(this1) 
...
__tink_json_Writer205.new = function() 
  local self = _hx_new(__tink_json_Writer205.prototype)
  __tink_json_Writer205.super(self)
  return self
end
__tink_json_Writer205.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer205.__name__ = true
__tink_json_Writer205.prototype = _hx_e();
__tink_json_Writer205.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.process5 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer205.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer205.prototype.__class__ =  __tink_json_Writer205
__tink_json_Writer205.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer205.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer206.new = function() 
  local self = _hx_new(__tink_json_Writer206.prototype)
  __tink_json_Writer206.super(self)
  return self
end
__tink_json_Writer206.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer206.__name__ = true
__tink_json_Writer206.prototype = _hx_e();
__tink_json_Writer206.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer206.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer206.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer206.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer206.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.algorithm;
...
__tink_json_Writer206.prototype.process5 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer206.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer206.prototype.__class__ =  __tink_json_Writer206
__tink_json_Writer206.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer206.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer207.new = function() 
  local self = _hx_new(__tink_json_Writer207.prototype)
  __tink_json_Writer207.super(self)
  return self
end
__tink_json_Writer207.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer207.__name__ = true
__tink_json_Writer207.prototype = _hx_e();
__tink_json_Writer207.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer207.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer207.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.name;
...
__tink_json_Writer207.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer207.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer207.prototype.__class__ =  __tink_json_Writer207
__tink_json_Writer207.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer207.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer208.new = function() 
  local self = _hx_new(__tink_json_Writer208.prototype)
  __tink_json_Writer208.super(self)
  return self
end
__tink_json_Writer208.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer208.__name__ = true
__tink_json_Writer208.prototype = _hx_e();
__tink_json_Writer208.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer208.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer208.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer208.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer208.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.algorithm;
...
__tink_json_Writer208.prototype.process5 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer208.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer208.prototype.__class__ =  __tink_json_Writer208
__tink_json_Writer208.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer208.prototype,{__index=__tink_json_BasicWriter.prototype})
...
local _hx_static_init = function()
  ...
  __gmdebug_lua_Exceptions.debugNames = __haxe_ds_ObjectMap.new();
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Kilo Echo";
