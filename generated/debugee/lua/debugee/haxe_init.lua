...
setfenv(1,haxeEnv) --if using more than one project + dce, global collisions and missing indexes will ensue. dont want that --build ident: Golf Zulu
...
__tink_json_Writer15 = _hx_e()
__tink_json_Writer16 = _hx_e()
__tink_json_Writer17 = _hx_e()
__tink_json_Writer18 = _hx_e()
...
__gmdebug_lua_Debugee.start = function() 
  ...
  elseif not _hx_status then 
    ...
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=123,className="gmdebug.lua.Debugee",methodName="start"}));
  ...
  __haxe_Log.trace("Connected to server...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=127,className="gmdebug.lua.Debugee",methodName="start"}));
  __gmdebug_lua_Debugee.socketActive = true;
  __haxe_Log.trace("initEvent about to be sent...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=129,className="gmdebug.lua.Debugee",methodName="start"}));
  local js = __haxe_Json.stringify(__gmdebug_composer_ComposedEvent.new("initialized"));
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  __haxe_Log.trace("initEvent sent...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=132,className="gmdebug.lua.Debugee",methodName="start"}));
  ...
  if (not __gmdebug_lua_Debugee.startLoop()) then 
    __haxe_Log.trace("Failed to setup debugger after timeout", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=143,className="gmdebug.lua.Debugee",methodName="start"}));
    do return false end;
  end;
  _G.DebugHook.addHook("gmdebug", __gmdebug_lua_DebugLoop.debugloop, "c");
...
__gmdebug_lua_Debugee.hookPlayer = function() 
  ...
  while (_g_nextV ~= nil) do 
    ...
    _g_nextV = _hx_3_nextResult_value;
    __haxe_Log.trace(v, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=174,className="gmdebug.lua.Debugee",methodName="hookPlayer"}));
  end;
...
__gmdebug_lua_Debugee.traceback = function(err) 
  ...
  if (__gmdebug_lua_Debugee.pauseLoopActive or __gmdebug_lua_Debugee.tracebackActive) then 
    __haxe_Log.trace(Std.string(Std.string(Std.string("traceback failed... ") .. Std.string(Std.string(__gmdebug_lua_Debugee.pauseLoopActive))) .. Std.string(" ")) .. Std.string(Std.string(__gmdebug_lua_Debugee.tracebackActive)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=203,className="gmdebug.lua.Debugee",methodName="traceback"}));
    do return err end;
  end;
  local tmp;
...
__gmdebug_lua_Debugee.poll = function() 
  ...
  elseif not _hx_status then 
    local _g = _hx_result;
    local _g = __haxe_Exception.caught(_g);
    __haxe_Log.trace(_g:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=266,className="gmdebug.lua.Debugee",methodName="poll"}));
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result
  end;
end
__gmdebug_lua_Debugee.main = function() 
  ...
  __haxe_Log.trace("before socketactive", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=292,className="gmdebug.lua.Debugee",methodName="main"}));
  while (not __gmdebug_lua_Debugee.socketActive) do 
    ...
    elseif not _hx_status then 
      ...
      __gmdebug_lua_Debugee.set_socket(nil);
      __haxe_Log.trace(_g:details(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=300,className="gmdebug.lua.Debugee",methodName="main"}));
...
__gmdebug_lua_Debugee.startHaltLoop = function(reason,bd,txt) 
  ...
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  __haxe_Log.trace("HALT LOOP", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=355,className="gmdebug.lua.Debugee",methodName="startHaltLoop"}));
...
__gmdebug_lua_handlers_HScopes.prototype.handle = function(self,scopeReq) 
  ...
  local js = __tink_json_Writer15.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmdebug_lua_handlers_HSetBreakpoints.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer16.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmdebug_lua_handlers_HStackTrace.prototype.handle = function(self,x) 
  ...
  if (not __gmdebug_lua_Debugee.pauseLoopActive) then 
    ...
    local js = __tink_json_Writer18.new():write(response);
    local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
    __gmdebug_lua_Debugee.socket.output:writeString(str);
    __gmdebug_lua_Debugee.socket.output:flush();
...
__gmdebug_lua_handlers_HVariables.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer17.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__tink_json_Writer15.new = function() 
  local self = _hx_new(__tink_json_Writer15.prototype)
  __tink_json_Writer15.super(self)
  return self
end
__tink_json_Writer15.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer15.__name__ = true
__tink_json_Writer15.prototype = _hx_e();
__tink_json_Writer15.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer15.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer15.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer15.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer15.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer15.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer15.prototype.__class__ =  __tink_json_Writer15
__tink_json_Writer15.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer15.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer16.new = function() 
  local self = _hx_new(__tink_json_Writer16.prototype)
  __tink_json_Writer16.super(self)
  return self
end
__tink_json_Writer16.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer16.__name__ = true
__tink_json_Writer16.prototype = _hx_e();
__tink_json_Writer16.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer16.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer16.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer16.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer16.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.algorithm;
...
__tink_json_Writer16.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer16.prototype.__class__ =  __tink_json_Writer16
__tink_json_Writer16.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer16.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer17.new = function() 
  local self = _hx_new(__tink_json_Writer17.prototype)
  __tink_json_Writer17.super(self)
  return self
end
__tink_json_Writer17.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer17.__name__ = true
__tink_json_Writer17.prototype = _hx_e();
__tink_json_Writer17.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer17.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer17.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.name;
...
__tink_json_Writer17.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer17.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer17.prototype.__class__ =  __tink_json_Writer17
__tink_json_Writer17.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer17.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer18.new = function() 
  local self = _hx_new(__tink_json_Writer18.prototype)
  __tink_json_Writer18.super(self)
  return self
end
__tink_json_Writer18.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer18.__name__ = true
__tink_json_Writer18.prototype = _hx_e();
__tink_json_Writer18.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer18.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer18.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer18.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer18.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.algorithm;
...
__tink_json_Writer18.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer18.prototype.__class__ =  __tink_json_Writer18
__tink_json_Writer18.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer18.prototype,{__index=__tink_json_BasicWriter.prototype})
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Uniform Zulu";
