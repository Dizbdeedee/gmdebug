...
setfenv(1,haxeEnv) --if using more than one project + dce, global collisions and missing indexes will ensue. dont want that --build ident: Tango Victor
...
__gmdebug_lua_CustomHandlers.prototype.h_initalInfo = function(self,x) 
  ...
  if (x.body.dapMode == "Launch") then 
    ...
    local data = __haxe_Json.stringify(__gmdebug_composer_ComposedGmDebugMessage.new(4, _hx_o({__fields__={ip=true,isLan=true},ip=_G.game.GetIPAddress(),isLan=__gmdebug_lua_util__Util_Util_Fields_.isLan()})));
...
__gmdebug_lua_Debugee.prototype.start = function(self) 
  ...
  self:hookPlayer();
  local data = __haxe_Json.stringify(__gmdebug_composer_ComposedEvent.new("continued", _hx_o({__fields__={threadId=true,allThreadsContinued=true},threadId=0,allThreadsContinued=true})));
  local str = "Content-Length: " .. #data .. "\r\n\r\n" .. data;
  self.socket.output:writeString(str);
  self.socket.output:flush();
...
__gmdebug_lua_Debugee.prototype.hookPlayer = function(self) 
  ...
  while (_g_nextV ~= nil) do 
    local v = _g_nextV;
    local _hx_3_nextResult_index, _hx_3_nextResult_value = _g_lnext(tbl, _g_i);
    _g_i = _hx_3_nextResult_index;
    _g_nextV = _hx_3_nextResult_value;
    __haxe_Log.trace(v, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=220,className="gmdebug.lua.Debugee",methodName="hookPlayer"}));
  end;
end
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Tango Victor";
