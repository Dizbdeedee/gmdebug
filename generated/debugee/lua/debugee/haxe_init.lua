...
setfenv(1,haxeEnv) --if using more than one project + dce, global collisions and missing indexes will ensue. dont want that --build ident: null Foxtrot
...
__gmdebug_lua_Debugee.prototype.start = function(self) 
  ...
  elseif not _hx_status then 
    ...
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=126,className="gmdebug.lua.Debugee",methodName="start"}));
    do return false end;
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result
  end;
...
__gmdebug_lua_Debugee.prototype.hookPlayer = function(self) 
  ...
  _G.hook.Add("PlayerDisconnected", "gmdebug-byeplayer", function(ply) 
    local data = __haxe_Json.stringify(__gmdebug_composer_ComposedGmDebugMessage.new(1, _hx_o({__fields__={playerID=true},playerID=ply:UserID()})));
    local str = "Content-Length: " .. #data .. "\r\n\r\n" .. data;
  ...
  while (ply_nextV ~= nil) do 
    ...
    local ply = v;
    local data = __haxe_Json.stringify(__gmdebug_composer_ComposedGmDebugMessage.new(0, _hx_o({__fields__={name=true,playerID=true},name=ply:Name(),playerID=ply:UserID()})));
    local str = "Content-Length: " .. #data .. "\r\n\r\n" .. data;
    self.socket.output:writeString(str);
    self.socket.output:flush();
  end;
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Echo Sierra";
