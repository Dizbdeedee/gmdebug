...
__tink_json_Writer255 = _hx_e()
__tink_json_Writer256 = _hx_e()
...
__gmdebug_lua_handlers_HEvaluate.createEvalEnvironment = function(stackLevel) 
  ...
  local info = _G.debug.getinfo(stackLevel + 1, "f");
  local fenv = nil;
  ...
  while (_g < 9999) do 
    _g = _g + 1;
    local i = _g - 1;
    local _hx_2_lcl_a, _hx_2_lcl_b = _G.debug.getlocal(stackLevel + 1, i);
...
__gmdebug_lua_handlers_HSetBreakpoints.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer254.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__gmdebug_lua_handlers_HStackTrace.prototype.handle = function(self,x) 
  ...
  if (not __gmdebug_lua_Debugee.inpauseloop) then 
    ...
    local js = __tink_json_Writer256.new():write(response);
    local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
    __gmdebug_lua_Debugee.socket.output:writeString(str);
    __gmdebug_lua_Debugee.socket.output:flush();
...
__gmdebug_lua_handlers_HVariables.prototype.handle = function(self,req) 
  ...
  local js = __tink_json_Writer255.new():write(resp);
  local str = "Content-Length: " .. #js .. "\r\n\r\n" .. js;
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  do return __gmdebug_lua_handlers_HandlerResponse.WAIT end
...
__tink_json_Writer254.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer254.prototype.process5 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer255.new = function() 
  local self = _hx_new(__tink_json_Writer255.prototype)
  __tink_json_Writer255.super(self)
  return self
end
__tink_json_Writer255.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer255.__name__ = true
__tink_json_Writer255.prototype = _hx_e();
__tink_json_Writer255.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer255.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer255.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer255.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer255.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer255.prototype.__class__ =  __tink_json_Writer255
__tink_json_Writer255.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer255.prototype,{__index=__tink_json_BasicWriter.prototype})

__tink_json_Writer256.new = function() 
  local self = _hx_new(__tink_json_Writer256.prototype)
  __tink_json_Writer256.super(self)
  return self
end
__tink_json_Writer256.super = function(self) 
  __tink_json_BasicWriter.super(self);
end
__tink_json_Writer256.__name__ = true
__tink_json_Writer256.prototype = _hx_e();
__tink_json_Writer256.prototype.process0 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.command;
...
__tink_json_Writer256.prototype.process1 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer256.prototype.process2 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer256.prototype.process3 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer256.prototype.process4 = function(self,value) 
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
  local value1 = value.algorithm;
...
__tink_json_Writer256.prototype.process5 = function(self,value) 
  local __first = true;
  local _this = self.buf;
  _G.table.insert(_this.b, _G.string.char(123));
  _this.length = _this.length + 1;
...
__tink_json_Writer256.prototype.write = function(self,value) 
  self:init();
  self:process0(value);
  do return _G.table.concat(self.buf.b) end
end

__tink_json_Writer256.prototype.__class__ =  __tink_json_Writer256
__tink_json_Writer256.__super__ = __tink_json_BasicWriter
setmetatable(__tink_json_Writer256.prototype,{__index=__tink_json_BasicWriter.prototype})
