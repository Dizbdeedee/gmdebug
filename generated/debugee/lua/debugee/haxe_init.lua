...
setfenv(1,haxeEnv) --if using more than one project + dce, global collisions and missing indexes will ensue. dont want that --build ident: Tango Charlie
...
__gmdebug_lua_io_PipeInput.super = function(self) 
  __haxe_Log.trace("Input exists", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/io/PipeSocket.hx",lineNumber=41,className="gmdebug.lua.io.PipeInput",methodName="new"}));
  if (not _G.file.Exists(__gmdebug_Cross.INPUT, "DATA")) then 
    _G.error(__haxe_Exception.thrown("Input pipe does not exist"),0);
  end;
  __haxe_Log.trace("input open", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/io/PipeSocket.hx",lineNumber=45,className="gmdebug.lua.io.PipeInput",methodName="new"}));
...
__gmdebug_lua_io_PipeOutput.super = function(self) 
  __haxe_Log.trace("output open", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/io/PipeSocket.hx",lineNumber=65,className="gmdebug.lua.io.PipeOutput",methodName="new"}));
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Papa Mike";
