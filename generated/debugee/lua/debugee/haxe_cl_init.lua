...
__gmdebug_Cross.readHeader = function(x) 
  ...
  local garbage = x:readLine();
  _G.file.Append(__haxe_io_Path.join(_hx_tab_array({[0]=__gmdebug_Cross.FOLDER, "log.txt"}, 2)), Std.string(Std.string(raw_content) .. Std.string(garbage)) .. Std.string((Std.string(Std.string(";") .. Std.string(content_length)) .. Std.string(";"))));
...
__gmdebug_Cross.recvMessage = function(x) 
  ...
  local dyn = x:readString(len, __haxe_io_Encoding.UTF8);
  _G.file.Append(__haxe_io_Path.join(_hx_tab_array({[0]=__gmdebug_Cross.FOLDER, "log.txt"}, 2)), dyn);
  do return __gmdebug_MessageResult.MESSAGE(__haxe_Json.parse(dyn)) end;
end
...
__gmdebug_lua_Debugee.main = function() 
  ...
  _G.timer.Create("gmdebug-start", 3, 0, function() 
    ...
    elseif not _hx_status then 
      ...
      __gmdebug_lua_Debugee.set_socket(nil);
      __haxe_Log.trace(Std.string("closed socket on error ") .. Std.string(_g:toString()), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=294,className="gmdebug.lua.Debugee",methodName="main"}));
      __haxe_Log.trace(_g:details(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=295,className="gmdebug.lua.Debugee",methodName="main"}));
    elseif _hx_result ~= _hx_pcall_default then
      return _hx_result
    end;
  end);
...
__gmdebug_lua_Debugee.startHaltLoop = function(reason,bd,txt) 
  ...
  __gmdebug_lua_Debugee.socket.output:writeString(str);
  __gmdebug_lua_Debugee.socket.output:flush();
  __haxe_Log.trace("HALT LOOP", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=332,className="gmdebug.lua.Debugee",methodName="startHaltLoop"}));
...
__gmdebug_lua_Debugee.abortDebugee = function() 
  ...
  __haxe_Log.trace("Debugging aborted", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/gmdebug/lua/Debugee.hx",lineNumber=355,className="gmdebug.lua.Debugee",methodName="abortDebugee"}));
...
__gmdebug_lua_Jit.init = function() 
  __gmdebug_lua_Jit.netJit.signal:listen(function(_) 
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Golf Bravo";
