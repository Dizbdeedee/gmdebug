...
class PromiseUtil {
	...
	public static extern inline function prom_exec(cl:Class<ChildProcess>, command:String,
			?options:ChildProcessExecOptions):Promise<Dynamic> {
		return Promisify.promisify(ChildProcess.exec)(command, options)
			.toPromise();
	}
