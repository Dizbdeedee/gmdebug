...
import gmdebug.lua.debugee.io.DataHandshake;
...
import gmdebug.lua.debugee.io.PipeSocket;
import gmdebug.lua.debugee.handlers.IHandler.HandlerResponse;
import gmod.libs.GameLib;
import gmdebug.lua.debugee.HandlerContainer;
import haxe.io.Input;
import gmdebug.lua.debugee.io.DebugIO;
...
class Debugee {
	...
	inline function parseInput(x:Input):MessageResult {
		// socket.unsafe()
		// 	.output.writeString("\004"); //do we actually need this?
		socket.unsafe()
			.output.flush();
