...
enum abstract GmDebugError(Int) to Int {
	...
	var DEBUGGER_INVALID_COPYFOLDER_ABSOLUTE;
...
var GMDEBUG_ERROR_STRINGS = [
	...
	DEBUGGER_INVALID_PROGRAMPATH_UNSPECIFIFED =>
	"Gmdebug requires the property \"programPath\" to be specified when launching",
	...
	DEBUGGER_INVALID_SERVERFOLDER_UNSPECIFIED =>
	"Gmdebug requires the property \"serverFolder\" to be specified",
	DEBUGGER_INVALID_SERVERFOLDER_NOTABSOLUTE =>
	"Gmdebug requires the property \"serverFolder\" to be an absolute path (i.e from root folder)",
	...
	DEBUGGER_INVALID_SERVERFOLDER_NOTGMOD =>
	"\"serverFolder\" does not seem to be a garrysmod directory. (looking for \"addons\" folder)",
	DEBUGGER_INVALID_CLIENTFOLDER_UNSPECIFIED =>
	"If you wish to debug clients, you must specify clientFolder first, or add the option nodebugClient into your launch options",
	DEBUGGER_INVALID_CLIENTFOLDER_NOTABSOLUTE =>
	"Gmdebug requires client folder: {folder} to be an absolute path (i.e from root folder)",
	...
	DEBUGGER_INVALID_CLIENTFOLDER_NOTGMOD =>
	"The client folder: {folder} does not seem to be a garrysmod directory. (looking for \"addons\" folder)",
	DEBUGGER_INVALID_COPYFOLDER =>
	"If you wish to copy your addon to the server on debug, specify both addonName and copyAddonBaseFolder or add the option noCopy into your launch options"
];
