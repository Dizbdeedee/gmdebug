@:jsRequire("ffi-napi") @valueModuleOnly extern class FfiNapi {
	...
	**/
	...
	static function CIF(retType:ts.AnyOf2<String, ref_napi.Type_>, types:Array<ts.AnyOf2<String, ref_napi.Type_>>, ?abi:Float):global.Buffer;
	static function CIF_var(retType:ts.AnyOf2<String, ref_napi.Type_>, types:Array<ts.AnyOf2<String, ref_napi.Type_>>, numFixedArgs:Float, ?abi:Float):global.Buffer;
