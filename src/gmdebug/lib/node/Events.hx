...
@:jsRequire("events") extern class Events {
	...
	**/
	function addListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Events;
	...
	/**
		...
		```
	**/
	function on(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Events;
	...
	/**
		...
		```
	**/
	function once(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Events;
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Events;
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependOnceListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Events;
	...
	**/
	...
	@:native("once")
	static function once_(emitter:Events, eventName:ts.AnyOf2<String, js.lib.Symbol>,
		?options:Events):js.lib.Promise<Array<Dynamic>>;
	...
	**/
	@:native("on")
	static function on_(emitter:global.nodejs.EventEmitter, eventName:String,
		?options:Events):js.lib.AsyncIterableIterator<Dynamic>;
	...
	**/
	...
	static function listenerCount_(emitter:global.nodejs.EventEmitter,
	...
	/**
		...
		```
	**/
	static function getEventListeners(emitter:ts.AnyOf2<global.nodejs.EventEmitter, Events>,
