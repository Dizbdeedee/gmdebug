...
@:jsRequire("assert") @valueModuleOnly extern class Assert {
	...
	**/
	@:overload(function(actual:Any, expected:Any, ?message:ts.AnyOf2<String, js.lib.Error>,
		?operator_:String, ?stackStartFn:haxe.Constraints.Function):Any {})
	...
	**/
	...
	/**
		...
		instead of the `AssertionError`.
	**/
	static function notDeepStrictEqual(actual:Any, expected:Any,
		?message:ts.AnyOf2<String, js.lib.Error>):Void;
	...
	/**
		...
		argument.
	**/
	@:overload(function(block:() -> Any, error:node.assert.AssertPredicate,
		?message:ts.AnyOf2<String, js.lib.Error>):Void {})
	...
	**/
	@:overload(function(block:ts.AnyOf2<() -> js.lib.Promise<Any>, js.lib.Promise<Any>>,
		error:node.assert.AssertPredicate,
		?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<ts.Undefined> {})
	static function rejects(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>,
		?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<ts.Undefined>;
	...
	**/
	@:overload(function(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>,
		error:node.assert.AssertPredicate,
		?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<ts.Undefined> {})
	static function doesNotReject(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>,
		?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<ts.Undefined>;
	...
	**/
	...
	/**
		...
		instance of an `Error` then it will be thrown instead of the `AssertionError`.
	**/
	static function doesNotMatch(value:String, regExp:js.lib.RegExp,
		?message:ts.AnyOf2<String, js.lib.Error>):Void;
