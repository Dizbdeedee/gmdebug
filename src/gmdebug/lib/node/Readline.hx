...
@:jsRequire("readline") @valueModuleOnly extern class Readline {
	...
	**/
	...
	static function createInterface(input:global.nodejs.ReadableStream,
		?output:global.nodejs.WritableStream,
		?completer:ts.AnyOf2<node.readline.Completer, node.readline.AsyncCompleter>,
		?terminal:Bool):node.readline.Interface;
	...
	/**
		...
		```
	**/
	static function emitKeypressEvents(stream:global.nodejs.ReadableStream,
		?readlineInterface:node.readline.Interface):Void;

	/**
		The `readline.clearLine()` method clears current line of given `TTY` stream
		in a specified direction identified by `dir`.
	**/
	static function clearLine(stream:global.nodejs.WritableStream, dir:node.tty.Direction,
		?callback:() -> Void):Bool;
	...
	**/
	...
	/**
		...
		given `TTY` `stream`.
	**/
	static function cursorTo(stream:global.nodejs.WritableStream, x:Float, ?y:Float,
		?callback:() -> Void):Bool;
	...
	/**
		...
		```
	**/
	static function moveCursor(stream:global.nodejs.WritableStream, dx:Float, dy:Float,
		?callback:() -> Void):Bool;
}
