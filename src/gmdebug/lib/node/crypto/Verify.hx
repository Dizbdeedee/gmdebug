...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	**/
	@:overload(function(object:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput,
		VerifyPublicKeyInput>,
		signature:String, ?signature_format:BinaryToTextEncoding):Bool {})
	function verify(object:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput,
		VerifyPublicKeyInput>,
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Verify {})
