...
@:jsRequire("crypto", "ECDH") extern class ECDH {
	...
	**/
	...
	@:overload(function(otherPublicKey:global.nodejs.ArrayBufferView,
		outputEncoding:BinaryToTextEncoding):String {})
	@:overload(function(otherPublicKey:String, inputEncoding:BinaryToTextEncoding,
		outputEncoding:BinaryToTextEncoding):String {})
	...
	**/
	...
	/**
		...
		```
	**/
	static function convertKey(key:BinaryLike, curve:String, ?inputEncoding:BinaryToTextEncoding,
		?outputEncoding:String, ?format:ECDHKeyFormat):ts.AnyOf2<String, node.buffer.Buffer>;
}
