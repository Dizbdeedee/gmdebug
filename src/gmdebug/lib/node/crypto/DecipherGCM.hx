...
typedef DecipherGCM = {
	...
	/**
		...
		being thrown.
	**/
	@:overload(function(data:String, inputEncoding:Encoding):node.buffer.Buffer {})
	@:overload(function(data:global.nodejs.ArrayBufferView, inputEncoding:Null<Any>,
	...
	**/
	...
	function _transform(chunk:Dynamic, encoding:global.BufferEncoding,
	...
	**/
	...
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):DecipherGCM {})
