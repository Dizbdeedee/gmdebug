...
@:jsRequire("dgram", "Socket") extern class Socket extends node.Events {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(msg:ts.AnyOf3<String, haxe.ds.ReadOnlyArray<Dynamic>, js.lib.Uint8Array>,
		?port:Float, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void {})
	@:overload(function(msg:ts.AnyOf3<String, haxe.ds.ReadOnlyArray<Dynamic>, js.lib.Uint8Array>,
		?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void {})
	@:overload(function(msg:ts.AnyOf2<String, js.lib.Uint8Array>, offset:Float, length:Float, ?port:Float,
		?address:String, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void {})
	@:overload(function(msg:ts.AnyOf2<String, js.lib.Uint8Array>, offset:Float, length:Float, ?port:Float,
		?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void {})
	@:overload(function(msg:ts.AnyOf2<String, js.lib.Uint8Array>, offset:Float, length:Float,
		?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void {})
	function send(msg:ts.AnyOf3<String, haxe.ds.ReadOnlyArray<Dynamic>, js.lib.Uint8Array>, ?port:Float,
		?address:String, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void;
	...
	**/
	...
	/**
		...
		port, listening on all interfaces.
	**/
	function addSourceSpecificMembership(sourceAddress:String, groupAddress:String,
		?multicastInterface:String):Void;
	...
	/**
		...
		drop membership on all valid interfaces.
	**/
	function dropSourceSpecificMembership(sourceAddress:String, groupAddress:String,
		?multicastInterface:String):Void;
	...
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>,
		listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Socket;
