...
@:native("Buffer") extern class Buffer {
	...
	**/
	...
	@:overload(function(data:WithImplicitCoercion<ts.AnyOf3<String, js.lib.Uint8Array,
		haxe.ds.ReadOnlyArray<Float>>>):Buffer {})
	@:overload(function(str:ts.AnyOf3<String, {function valueOf():String;}, {}>,
		?encoding:BufferEncoding):Buffer {})
	static function from(arrayBuffer:WithImplicitCoercion<ts.AnyOf2<js.lib.ArrayBuffer,
