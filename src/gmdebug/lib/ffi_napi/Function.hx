...
@:jsRequire("ffi-napi", "Function") extern class Function {
	function new(retType:ts.AnyOf2<String, ref_napi.Type_>, argTypes:Array<ts.AnyOf2<String, ref_napi.Type_>>, ?abi:Float);
	/**
	...
	**/
	...
	var alignment : Float;
	@:selfCall
	static function call(retType:ts.AnyOf2<String, ref_napi.Type_>, argTypes:Array<ts.AnyOf2<String, ref_napi.Type_>>, ?abi:Float):Function;
}