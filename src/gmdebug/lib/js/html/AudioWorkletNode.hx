...
@:native("AudioWorkletNode") extern class AudioWorkletNode {
	function new(context:js.html.audio.BaseAudioContext, name:String,
		?options:js.html.audio.AudioWorkletNodeOptions);
	@:optional
	dynamic function onprocessorerror(ev:js.html.Event):Dynamic;
