...
@:native("webkitRTCPeerConnection") extern class WebkitRTCPeerConnection {
	...
	**/
	...
	function addIceCandidate(candidate:ts.AnyOf2<js.html.rtc.IceCandidate,
		RTCIceCandidateInit>):js.lib.Promise<ts.Undefined>;
	function addTrack(track:js.html.MediaStreamTrack,
		streams:haxe.extern.Rest<js.html.MediaStream>):js.html.rtc.RtpSender;
	function addTransceiver(trackOrKind:ts.AnyOf2<String, js.html.MediaStreamTrack>,
		?init:RTCRtpTransceiverInit):js.html.rtc.RtpTransceiver;
	function close():Void;
	...
	**/
	...
	static var prototype:WebkitRTCPeerConnection;
}
