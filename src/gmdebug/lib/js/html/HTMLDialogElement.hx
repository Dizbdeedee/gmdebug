...
@:native("HTMLDialogElement") extern class HTMLDialogElement {
	function new();
	var open:Bool;
	...
	/**
		...
		The event listener is appended to target's event listener list and is not appended if it has the same type, callback, and capture.
	**/
	@:overload(function(type:String, listener:EventListenerOrEventListenerObject,
	...
	**/
	...
	function insertAdjacentElement(position:InsertPosition,
		insertedElement:js.html.DOMElement):Null<js.html.DOMElement>;
	...
	**/
	function requestFullscreen(?options:FullscreenOptions):js.lib.Promise<ts.Undefined>;
	...
	**/
	...
	function animate(keyframes:Null<ts.AnyOf2<Array<Keyframe>, PropertyIndexedKeyframes>>,
		?options:ts.AnyOf2<Float, js.html.KeyframeAnimationOptions>):js.html.Animation;
	...
	**/
	...
	static var prototype:HTMLDialogElement;
}
