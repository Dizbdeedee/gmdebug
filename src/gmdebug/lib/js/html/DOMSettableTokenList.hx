...
@:native("DOMSettableTokenList") extern class DOMSettableTokenList {
	function new();
	...
	**/
	...
	function forEach(callbackfn:(value:String, key:Float, parent:js.html.DOMTokenList) -> Void,
		?thisArg:Dynamic):Void;
	function entries():js.lib.IterableIterator<ts.Tuple2<Float, String>>;
