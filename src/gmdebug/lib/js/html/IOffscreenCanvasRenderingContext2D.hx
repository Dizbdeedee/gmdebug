...
typedef IOffscreenCanvasRenderingContext2D = {
	...
	@:overload(function(image:CanvasImageSource, sx:Float, sy:Float, sw:Float, sh:Float, dx:Float, dy:Float,
	...
	function createRadialGradient(x0:Float, y0:Float, r0:Float, x1:Float, y1:Float,
		r1:Float):js.html.CanvasGradient;
	var filter:String;
	...
	@:overload(function(imagedata:js.html.ImageData, dx:Float, dy:Float, dirtyX:Float, dirtyY:Float,
		dirtyWidth:Float, dirtyHeight:Float):Void {})
	...
	function ellipse(x:Float, y:Float, radiusX:Float, radiusY:Float, rotation:Float, startAngle:Float,
