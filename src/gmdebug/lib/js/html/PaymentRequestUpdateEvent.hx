...
@:native("PaymentRequestUpdateEvent") extern class PaymentRequestUpdateEvent {
	...
	function updateWith(detailsPromise:ts.AnyOf2<PaymentDetailsUpdate,
		js.lib.Promise<PaymentDetailsUpdate>>):Void;
	...
	**/
	...
	final NONE:Float;
	static var prototype:PaymentRequestUpdateEvent;
}
