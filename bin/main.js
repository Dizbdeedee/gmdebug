...
class gmdebug_dap_LaunchProcess {
	...
	setupLinux(programPath,luaDebug,argString) {
		...
		this.childProcess.on("error",function(err) {
			...
			haxe_Log.trace("Child process error///",{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 60, className : "gmdebug.dap.LaunchProcess", methodName : "setupLinux"});
			haxe_Log.trace(err.message,{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 61, className : "gmdebug.dap.LaunchProcess", methodName : "setupLinux"});
			haxe_Log.trace(err.stack,{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 62, className : "gmdebug.dap.LaunchProcess", methodName : "setupLinux"});
			haxe_Log.trace("Child process error end///",{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 63, className : "gmdebug.dap.LaunchProcess", methodName : "setupLinux"});
			luaDebug.shutdown();
		});
	}
	...
	setupWindows(programPath,luaDebug,argString) {
		...
		this.worker.on("error",function(err) {
			...
			haxe_Log.trace("sending from dap " + _this.event,{ fileName : "src/gmdebug/composer/ComposedEvent.hx", lineNumber : 32, className : "gmdebug.composer.ComposedEvent", methodName : "send"});
			luaDebug.sendEvent(_this);
			haxe_Log.trace("Worker error///",{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 94, className : "gmdebug.dap.LaunchProcess", methodName : "setupWindows"});
			haxe_Log.trace(err.message,{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 95, className : "gmdebug.dap.LaunchProcess", methodName : "setupWindows"});
			haxe_Log.trace(err.stack,{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 96, className : "gmdebug.dap.LaunchProcess", methodName : "setupWindows"});
			haxe_Log.trace("Worker error end///",{ fileName : "src/gmdebug/dap/LaunchProcess.hx", lineNumber : 97, className : "gmdebug.dap.LaunchProcess", methodName : "setupWindows"});
			luaDebug.shutdown();
		});
...
class gmdebug_dap_LuaDebugger extends vscode_debugAdapter_DebugSession {
	...
	checkPrograms() {
		...
		try {
			...
			let _g1 = haxe_Exception.caught(_g);
			haxe_Log.trace("Xdotool not found",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 93, className : "gmdebug.dap.LuaDebugger", methodName : "checkPrograms"});
			haxe_Log.trace(_g1.toString(),{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 94, className : "gmdebug.dap.LuaDebugger", methodName : "checkPrograms"});
		}
	}
	uncaughtException(err,origin) {
		haxe_Log.trace(err.message,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 99, className : "gmdebug.dap.LuaDebugger", methodName : "uncaughtException"});
		haxe_Log.trace(err.stack,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 100, className : "gmdebug.dap.LuaDebugger", methodName : "uncaughtException"});
		this.shutdown();
	}
				...
				while(_g_current < _this.length) {
					...
					if(!_gthis.clientsTaken.h.hasOwnProperty(_g1_key)) {
						try {
							...
							haxe_Log.trace("could not aquire in " + _g1_value,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 114, className : "gmdebug.dap.LuaDebugger", methodName : "playerAddedMessage"});
						}
					}
				}
	...
	processCustomMessages(x) {
		haxe_Log.trace("custom message",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 166, className : "gmdebug.dap.LuaDebugger", methodName : "processCustomMessages"});
		switch(x.msg) {
		case 0:
			this.playerAddedMessage(x.body).handle(function(out) {
				...
				case 0:
					if(out.data) {
						haxe_Log.trace("Whater a sucess",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 172, className : "gmdebug.dap.LuaDebugger", methodName : "processCustomMessages"});
					} else {
						haxe_Log.trace("Could not add a new player...",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 174, className : "gmdebug.dap.LuaDebugger", methodName : "processCustomMessages"});
					}
					break;
				case 1:
	...
	pokeServerNamedPipes(attachReq) {
		...
		return tink_core_Future.irreversible(function(__return) {
			try {
				...
				let timedout = true;
				haxe_Log.trace(timeout,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 194, className : "gmdebug.dap.LuaDebugger", methodName : "pokeServerNamedPipes"});
				let __doCount = 0;
	...
	startServer(attachReq) {
		...
		this.pokeServerNamedPipes(attachReq).handle(function(out) {
			switch(out._hx_index) {
			case 0:
				haxe_Log.trace("Attach success",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 280, className : "gmdebug.dap.LuaDebugger", methodName : "startServer"});
				let resp = gmdebug_composer_ComposeTools.compose(attachReq,"attach");
				haxe_Log.trace("sending from dap " + resp.command,{ fileName : "src/gmdebug/composer/ComposedResponse.hx", lineNumber : 52, className : "gmdebug.composer.ComposedResponse", methodName : "send"});
			...
			case 1:
				let _g = out.failure;
				haxe_Log.trace(_g.message,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 284, className : "gmdebug.dap.LuaDebugger", methodName : "startServer"});
	...
	handleMessage(message) {
		if(message.type == "request") {
			haxe_Log.trace("recieved request from client " + message.command,{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 302, className : "gmdebug.dap.LuaDebugger", methodName : "handleMessage"});
			try {
				this.requestRouter.route(message);
			} catch( _g ) {
				let e = haxe_Exception.caught(_g);
				haxe_Log.trace("Failed to handle message " + e.toString(),{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 307, className : "gmdebug.dap.LuaDebugger", methodName : "handleMessage"});
			...
			haxe_Log.trace("Not handlin that...",{ fileName : "src/gmdebug/dap/LuaDebugger.hx", lineNumber : 316, className : "gmdebug.dap.LuaDebugger", methodName : "handleMessage"});
		}
	}
}
...
class gmdebug_dap_PipeSocket {
	...
	aquireWindows() {
		...
		return tink_core_Future.irreversible(function(__return) {
			try {
				_gthis.aquireWindowsSocket().handle(function(__t9) {
					try {
						let __t9_result;
						...
						_gthis.makeLinksWindows(_gthis.locs.read,_gthis.locs.write);
	...
	aquireLinux() {
		...
		return tink_core_Future.irreversible(function(__return) {
			try {
				...
				_gthis.aquireReadSocket(_gthis.locs.read).handle(function(__t10) {
					try {
						let __t10_result;
						...
						_gthis.readS = __t10_result;
						_gthis.aquireWriteSocket(_gthis.locs.write).handle(function(__t11) {
							try {
								let __t11_result;
								...
								_gthis.writeS = __t11_result;
								js_node_Fs.writeFileSync(_gthis.locs.ready,"");
								_gthis.writeS.write("\x04\r\n");
								_gthis.readS.on("data",_gthis.readFunc);
								_gthis.aquired = true;
								haxe_Log.trace("Aquired socket...",{ fileName : "src/gmdebug/dap/PipeSocket.hx", lineNumber : 77, className : "gmdebug.dap.PipeSocket", methodName : "aquireLinux"});
								__return(tink_core_Outcome.Success(null));
								return;
							} catch( _g ) {
								let _g1 = haxe_Exception.caught(_g).unwrap();
	...
	makeLinksWindows(input,output) {
		if(!sys_FileSystem.exists(input) && !sys_FileSystem.exists(output)) {
			try {
				js_node_ChildProcess.execSync("mklink " + input + " " + gmdebug_dap_PipeSocket.WIN_PIPE_NAME);
				js_node_ChildProcess.execSync("mklink " + input + " " + gmdebug_dap_PipeSocket.WIN_PIPE_NAME);
			} catch( _g ) {
				haxe_Log.trace(haxe_Exception.caught(_g).toString(),{ fileName : "src/gmdebug/dap/PipeSocket.hx", lineNumber : 99, className : "gmdebug.dap.PipeSocket", methodName : "makeLinksWindows"});
			}
		}
	}
	aquireReadSocket(out) {
		return tink_core_Future.irreversible(function(__return) {
			try {
				...
				tink_core_Future.ofJsPromise(open(out,js_node_Fs.constants.O_RDONLY | js_node_Fs.constants.O_NONBLOCK)).handle(function(__t12) {
					try {
						let __t12_result;
	...
	aquireWindowsSocket() {
		return tink_core_Future.irreversible(function(__return) {
			try {
				...
				let _g = $bind(server,server.on);
				let eventName = "connection";
				let onConnect = function(listener) {
					return _g(eventName,listener);
				};
				tink_core_Future.irreversible(onConnect).handle(function(__t13) {
					try {
						let __t13_result;
						...
						let sock = __t13_result;
						haxe_Log.trace("We found the sock!",{ fileName : "src/gmdebug/dap/PipeSocket.hx", lineNumber : 115, className : "gmdebug.dap.PipeSocket", methodName : "aquireWindowsSocket"});
	...
	aquireWriteSocket(inp) {
		return tink_core_Future.irreversible(function(__return) {
			try {
				let open = js_node_util_Promisify(js_node_Fs.open);
				tink_core_Future.ofJsPromise(open(inp,js_node_Fs.constants.O_RDWR | js_node_Fs.constants.O_NONBLOCK)).handle(function(__t14) {
					try {
						let __t14_result;
						...
						let fd = __t14_result;
						haxe_Log.trace(fd,{ fileName : "src/gmdebug/dap/PipeSocket.hx", lineNumber : 122, className : "gmdebug.dap.PipeSocket", methodName : "aquireWriteSocket"});
...
class gmdebug_dap_RequestRouter {
	...
	h_variables(req) {
		...
		if(ref <= 0) {
			haxe_Log.trace("invalid variable reference",{ fileName : "src/gmdebug/dap/RequestRouter.hx", lineNumber : 98, className : "gmdebug.dap.RequestRouter", methodName : "h_variables"});
	...
	h_launch(req) {
		...
		if(_g == null) {
			...
			programPath = _g == "auto" ? Sys.systemName() == "Windows" ? "" + serverFolder + "/../srcds.exe" : "" + serverFolder + "/../srcds_run" : _g;
		}
		if(!haxe_io_Path.isAbsolute(programPath)) {
			programPath = haxe_io_Path.join([serverFolder,programPath]);
		}
