...
@:jsRequire("http", "Server") extern class Server extends node.net.Server {
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Server { })
	@:overload(function(event:String, listener:RequestListener):Server { })
	@:overload(function(event:String, listener:RequestListener):Server { })
	@:overload(function(event:String, listener:(err:js.lib.Error, socket:node.stream.Duplex) -> Void):Server { })
	@:overload(function(event:String, listener:(req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server { })
	@:overload(function(event:String, listener:RequestListener):Server { })
	@:overload(function(event:String, listener:(req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server { })
	...
	**/
	...
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String, req:IncomingMessage, res:ServerResponse):Bool { })
	@:overload(function(event:String, req:IncomingMessage, res:ServerResponse):Bool { })
	@:overload(function(event:String, err:js.lib.Error, socket:node.stream.Duplex):Bool { })
	@:overload(function(event:String, req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer):Bool { })
	@:overload(function(event:String, req:IncomingMessage, res:ServerResponse):Bool { })
	@:overload(function(event:String, req:IncomingMessage, socket:node.stream.Duplex, head:node.buffer.Buffer):Bool { })
