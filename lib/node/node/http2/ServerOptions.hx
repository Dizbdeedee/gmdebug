...
typedef ServerOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		...
		final consumers : {
			function buffer(stream:ts.AnyOf3<global.nodejs.ReadableStream, node.stream.Readable, js.lib.asyncit.AsyncIterator_Deux<Dynamic, Dynamic, Null<Any>>>):js.lib.Promise<node.buffer.Buffer>;
			function text(stream:ts.AnyOf3<global.nodejs.ReadableStream, node.stream.Readable, js.lib.asyncit.AsyncIterator_Deux<Dynamic, Dynamic, Null<Any>>>):js.lib.Promise<String>;
			function arrayBuffer(stream:ts.AnyOf3<global.nodejs.ReadableStream, node.stream.Readable, js.lib.asyncit.AsyncIterator_Deux<Dynamic, Dynamic, Null<Any>>>):js.lib.Promise<js.lib.ArrayBuffer>;
			function blob(stream:ts.AnyOf3<global.nodejs.ReadableStream, node.stream.Readable, js.lib.asyncit.AsyncIterator_Deux<Dynamic, Dynamic, Null<Any>>>):js.lib.Promise<js.html.Blob>;
			function json(stream:ts.AnyOf3<global.nodejs.ReadableStream, node.stream.Readable, js.lib.asyncit.AsyncIterator_Deux<Dynamic, Dynamic, Null<Any>>>):js.lib.Promise<Any>;
		};
		/**
		...
		**/
		...
		/**
			...
			Returns an `AsyncIterator_Deux` that iterates `eventName` events. It will throw
