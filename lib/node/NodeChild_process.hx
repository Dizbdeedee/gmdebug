...
@:jsRequire("node:child_process") @valueModuleOnly extern class NodeChild_process {
	...
	**/
	...
	@:overload(function(command:String, ?options:node.child_process.SpawnSyncOptions):node.child_process.SpawnSyncReturns<node.buffer.Buffer> { })
	...
	@:overload(function(command:String, ?args:haxe.ds.ReadOnlyArray<String>, ?options:node.child_process.SpawnSyncOptions):node.child_process.SpawnSyncReturns<node.buffer.Buffer> { })
	...
	**/
	...
	@:overload(function(file:String, ?args:haxe.ds.ReadOnlyArray<String>, ?options:node.child_process.ExecFileSyncOptions):node.buffer.Buffer { })
